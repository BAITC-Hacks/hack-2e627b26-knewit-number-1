...
ATTACHMENT_MAX_BYTES = max(1024, int(os.environ.get("ATTACHMENT_MAX_BYTES", str(10 * 1024 * 1024))))
ATTACHMENT_MAX_REQUEST_BYTES = max(
    ATTACHMENT_MAX_BYTES,
    int(os.environ.get("ATTACHMENT_MAX_REQUEST_BYTES", str(ATTACHMENT_MAX_BYTES + 65536))),
)
ATTACHMENT_MAX_EXTRACTED_CHARS = max(1000, int(os.environ.get("ATTACHMENT_MAX_EXTRACTED_CHARS", "6000")))
ATTACHMENT_MAX_FILENAME_CHARS = max(32, int(os.environ.get("ATTACHMENT_MAX_FILENAME_CHARS", "180")))
ATTACHMENT_MAX_ARCHIVE_MEMBERS = max(1, int(os.environ.get("ATTACHMENT_MAX_ARCHIVE_MEMBERS", "300")))
ATTACHMENT_MAX_ARCHIVE_MEMBER_BYTES = max(1024, int(os.environ.get("ATTACHMENT_MAX_ARCHIVE_MEMBER_BYTES", str(5 * 1024 * 1024))))
ATTACHMENT_MAX_UNCOMPRESSED_BYTES = max(1024, int(os.environ.get("ATTACHMENT_MAX_UNCOMPRESSED_BYTES", str(20 * 1024 * 1024))))
ATTACHMENT_MAX_COMPRESSION_RATIO = max(1, int(os.environ.get("ATTACHMENT_MAX_COMPRESSION_RATIO", "100")))
ATTACHMENT_MAX_PDF_PAGES = max(1, int(os.environ.get("ATTACHMENT_MAX_PDF_PAGES", "100")))
ATTACHMENT_MAX_STORED_PER_DIALOG = max(1, int(os.environ.get("ATTACHMENT_MAX_STORED_PER_DIALOG", "5")))
