...
const resources = {
  ru: {
    ...
    product: {
      card: "Карточка товара", image: "Изображение товара", missingImage: "Изображение: информация не найдена", eyebrow: "Товар из каталога EKT.kz", characteristics: ["Серия", "Полюса", "Номинальный ток", "Отключающая способность", "Напряжение", "Бренд"], characteristicsTitle: "Характеристики",
  ...
  kk: {
    ...
    product: { card: "Тауар карточкасы", image: "Тауар суреті", missingImage: "Сурет: ақпарат табылмады", eyebrow: "EKT.kz каталогындағы тауар", characteristics: ["Серия", "Полюстер", "Номиналды ток", "Ажырату қабілеті", "Кернеу", "Бренд"], characteristicsTitle: "Сипаттамалар", article: "Артикул", priceMissing: "Баға: ақпарат табылмады", availabilityUnknown: "Қолжетімділігі расталмады", available: (n, unit = "дана") => `Қолжетімді: ${n} ${unit}`, unavailable: "Қоймада жоқ", availabilityMissing: "Қалдық: ақпарат табылмады", cache: "Кэш деректері", live: "Live деректері", verified: "verified_at", age: "жасы", dataAgeNow: "жаңа ғана", dataAgeMinutes: (n) => `${n} мин бұрын`, dataAgeHours: (n) => `${n} сағ бұрын`, dataAgeDays: (n) => `${n} күн бұрын`, fit: "Неге сәйкес:", important: "Маңызды:", quantity: "Саны", checking: "Тексерілуде…", retry: "Қайталау", add: "Қосу", preparing: "Қорғалған себет сессиясы дайындалуда", reconnect: "Келесі әрекетте байланыс қалпына келеді", summaryHint: "Алдымен қорытындыны көрсетеміз", official: "Ресми тауар карточкасын ашу", officialMissing: "Ресми карточка: ақпарат табылмады" },
    analog: { comparison: "Аналогты салыстыру", label: "Ұсынылған аналог", instead: "Оның орнына", article: "Артикул", inStock: (n, unit = "дана") => `Қоймада бар: ${n} ${unit}`, unavailable: "Қоймада жоқ", missing: "Қалдық: ақпарат табылмады", live: "Баға мен қалдық live тексерілді", notLive: "Баға мен қалдық live расталмады", checked: "Тексерілді", why: "Неге сәйкес", matching: "Сәйкес параметрлер", differences: "Маңызды айырмашылықтар", original: "Бастапқы", analog: "Аналог", infoMissing: "Ақпарат табылмады" },
